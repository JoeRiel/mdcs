...
##  If true, when *skipping*, pass the content of the stack to the
##  predicate (in addition to passing the computed value).  Doing so
##  is memory intensive, so this option should not normally be used.
##  The content of the stack is the list generated by
##  ~debugopts(callstack)~.
##  The default is false; this option is sticky.
##
##
