...
(defun mds-out-view-proc (button)
  "Search for the Maple procedure in stack output.
Search from beginning of line at BUTTON for the Maple procedure
name and optional statement (call) in the output generated by the
'stack' and 'where' debugger commands."
  (goto-char (button-start button))
  (forward-line -1) ; move back to hidden address tag
...
(defun mds-out-buttonize-stack-args ()
  "Create a button to call `mds-out-call-stack' when pressed.
...
Return a cons cell of the address and procname."
